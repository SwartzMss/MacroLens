...
资本转移会改变交易双方资产负债表，例如债务减免或与投资相关的赠与；非生产非金融资产主要包括自然资源、可交易的契约、租约和许可，以及营销资产，例如品牌、商标和域名等。专利和版权在 BPM6 下不再作为非生产非金融资产计入资本账户；相关研发成果或知识产权交易需要根据交易性质归入相应服务项目。它们不同于经常账户的收入，也不同于金融资产交易。
