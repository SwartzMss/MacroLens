...
下方历史图保留官方调息生效日或操作日，水平线表示沿用此前公布的利率，不代表每日或每月都新增了一次观测。2024-07-19 是图表起始时已知的操作利率水平，并非该水平的首次生效日；2024-07-22 前后的政策框架和招标方式应区别理解。图表末端截至最近一次明确列出 7 天期利率的官方公告；仅公布零操作量而未列利率的公告不会被当作新的利率读数。
