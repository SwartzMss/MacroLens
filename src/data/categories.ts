export const categoryIds = ['money', 'credit', 'policy', 'inflation', 'growth', 'housing', 'fiscal', 'exchange', 'external', 'labor', 'markets'] as const;
...
export const categories: Record<CategoryId, { label: string; description: string; order: number }> = {
  ...
  credit: { label: '信用与融资', description: '理解贷款、社会融资与利率如何连接金融体系和实体经济。', order: 15 },
  policy: { label: '货币政策', description: '理解政策目标、工具操作与金融条件之间的传导。', order: 20 },
