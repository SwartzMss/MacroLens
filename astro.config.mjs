...
export default defineConfig({
  ...
  integrations: site ? [sitemap({ filter: (page) => (!new URL(page).pathname.startsWith('/learn/') || new URL(page).pathname === '/learn/' || new URL(page).pathname.startsWith('/learn/course/') || new URL(page).pathname.startsWith('/learn/explore/')) })] : [],
});
