...
const approvedMetadata = {
  'interbank-rate': { id: 'interbank-rate', name: '银行间资金利率（DR007 / R007）', subtitle: '市场成交形成的短期资金价格，不等于央行政策操作利率', country: 'CN', category: 'markets', source: '中国人民银行与全国银行间同业拆借中心', definition: { source: 'CFETS 质押式回购指标口径', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['policy-rate', 'omo', 'lpr', 'credit'], graph: 'macro', order: 1 },
  'government-bond-yield': { id: 'government-bond-yield', name: '国债收益率', subtitle: '由债券价格和现金流共同决定的市场贴现率，不是票面利率或债券价格', country: 'CN', category: 'markets', source: '财政部与中央国债登记结算有限责任公司', definition: { source: '财政部-中国国债收益率曲线编制说明', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['yield-curve', 'real-interest-rate', 'credit-spread', 'government-debt'], graph: 'macro', order: 2 },
  'yield-curve': { id: 'yield-curve', name: '收益率曲线', subtitle: '把可比债券的期限与收益率连接起来，曲线形态不是单一经济预测', country: 'CN', category: 'markets', source: '中央国债登记结算有限责任公司', definition: { source: '中债收益率曲线编制说明', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['government-bond-yield', 'real-interest-rate', 'credit-spread', 'policy-rate'], graph: 'macro', order: 3 },
  'real-interest-rate': { id: 'real-interest-rate', name: '实际利率', subtitle: '剔除通胀后的利率概念，必须说明预期或实现通胀及匹配期限', country: 'CN', category: 'markets', source: '中国人民银行与国际货币基金组织', definition: { source: 'Fisher relation and official monetary-policy usage', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['government-bond-yield', 'yield-curve', 'policy-rate', 'cpi'], graph: 'macro', order: 4 },
  'credit-spread': { id: 'credit-spread', name: '信用利差', subtitle: '信用债收益率相对可比基准的差额，不只反映违约风险', country: 'CN', category: 'markets', source: '中央国债登记结算有限责任公司', definition: { source: '中债收益率曲线与估值方法', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['government-bond-yield', 'yield-curve', 'real-interest-rate', 'credit'], graph: 'macro', order: 5 },
};
