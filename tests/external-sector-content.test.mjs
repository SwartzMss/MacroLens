...
const approvedMetadata = {
  ...
  exports: { id: 'exports', name: '出口', subtitle: '货物或服务向境外流出的贸易概念，必须先区分海关统计与国际收支口径', country: 'CN', category: 'external', source: '海关总署、国家外汇管理局与国际货币基金组织', definition: { source: '海关统计、SAFE 与 IMF BPM6', asOf: '2026-09' }, updatedAt: '2026-09-02', related: ['imports', 'trade-balance', 'trade-volume-and-price', 'exchange-rate', 'current-account'], graph: 'macro', order: 6, level: 'basic', topics: ['balance-of-payments'], prerequisites: ['exchange-rate'], featured: false },
  imports: { id: 'imports', name: '进口', subtitle: '货物或服务自境外流入的贸易概念，必须先区分海关统计与国际收支口径', country: 'CN', category: 'external', source: '海关总署、国家外汇管理局与国际货币基金组织', definition: { source: '海关统计、SAFE 与 IMF BPM6', asOf: '2026-09' }, updatedAt: '2026-09-02', related: ['exports', 'trade-balance', 'trade-volume-and-price', 'exchange-rate', 'current-account'], graph: 'macro', order: 7, level: 'basic', topics: ['balance-of-payments'], prerequisites: ['exchange-rate'], featured: false },
