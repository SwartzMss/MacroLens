...
const approvedMetadata = {
  'balance-of-payments': { id: 'balance-of-payments', name: '国际收支', subtitle: '记录居民与非居民在某一期间经济交易的统计报表，不是外部资产负债存量表', country: 'CN', category: 'external', source: '国家外汇管理局与国际货币基金组织', definition: { source: 'SAFE 与 IMF BPM6', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['current-account', 'financial-account', 'cross-border-capital-flows', 'foreign-exchange-reserves'], graph: 'macro', order: 1 },
  'current-account': { id: 'current-account', name: '经常账户', subtitle: '汇总货物和服务、初次收入与二次收入的跨境交易流量', country: 'CN', category: 'external', source: '国家外汇管理局与国际货币基金组织', definition: { source: 'SAFE 与 IMF BPM6', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['balance-of-payments', 'financial-account', 'cross-border-capital-flows', 'exchange-rate'], graph: 'macro', order: 2 },
  'financial-account': { id: 'financial-account', name: '金融账户', subtitle: '记录居民与非居民金融资产和负债交易，读正负号前必须确认列示方法', country: 'CN', category: 'external', source: '国家外汇管理局与国际货币基金组织', definition: { source: 'SAFE 与 IMF BPM6', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['balance-of-payments', 'current-account', 'cross-border-capital-flows', 'foreign-exchange-reserves'], graph: 'macro', order: 3 },
  'cross-border-capital-flows': { id: 'cross-border-capital-flows', name: '跨境资本流动', subtitle: '对多类跨境金融交易的分析性总称，不是一条统一口径的官方指标', country: 'CN', category: 'external', source: '国家外汇管理局与国际货币基金组织', definition: { source: 'SAFE 与 IMF BPM6', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['financial-account', 'balance-of-payments', 'current-account', 'exchange-rate', 'foreign-exchange-reserves'], graph: 'macro', order: 4 },
  'effective-exchange-rate': { id: 'effective-exchange-rate', name: '有效汇率（NEER / REER）', subtitle: '汇总本币相对一篮子货币变化的多边指数，并可进一步纳入相对价格', country: 'CN', category: 'external', source: '国际清算银行与中国外汇交易中心', definition: { source: 'BIS effective exchange rates methodology', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['exchange-rate', 'usd-cny', 'cfets-rmb-index', 'current-account'], graph: 'macro', order: 5 },
  exports: { id: 'exports', name: '出口', subtitle: '货物或服务向境外流出的贸易概念，必须先区分海关统计与国际收支口径', country: 'CN', category: 'external', source: '海关总署、国家外汇管理局与国际货币基金组织', definition: { source: '海关统计、SAFE 与 IMF BPM6', asOf: '2026-09' }, updatedAt: '2026-09-13', related: ['imports', 'trade-balance', 'trade-volume-and-price', 'exchange-rate', 'current-account'], graph: 'macro', order: 6, level: 'basic', topics: ['balance-of-payments'], prerequisites: ['exchange-rate'], featured: false },
  imports: { id: 'imports', name: '进口', subtitle: '货物或服务自境外流入的贸易概念，必须先区分海关统计与国际收支口径', country: 'CN', category: 'external', source: '海关总署、国家外汇管理局与国际货币基金组织', definition: { source: '海关统计、SAFE 与 IMF BPM6', asOf: '2026-09' }, updatedAt: '2026-09-13', related: ['exports', 'trade-balance', 'trade-volume-and-price', 'exchange-rate', 'current-account'], graph: 'macro', order: 7, level: 'basic', topics: ['balance-of-payments'], prerequisites: ['exchange-rate'], featured: false },
  'trade-balance': { id: 'trade-balance', name: '贸易差额', subtitle: '在明确货物、服务及统计口径后计算的出口减进口差额，不等同经常账户余额', country: 'CN', category: 'external', source: '海关总署、国家外汇管理局与国际货币基金组织', definition: { source: '海关统计、SAFE 与 IMF BPM6', asOf: '2026-09' }, updatedAt: '2026-09-13', related: ['exports', 'imports', 'current-account', 'trade-volume-and-price'], graph: 'macro', order: 8, level: 'basic', topics: ['balance-of-payments'], prerequisites: ['exports', 'imports'], featured: false },
  'trade-volume-and-price': { id: 'trade-volume-and-price', name: '贸易数量与价格拆分', subtitle: '把进出口金额变化拆解为数量和价格变化的分析框架', country: 'CN', category: 'external', source: '国家统计局、国家外汇管理局与国际货币基金组织', definition: { source: '国民经济核算、SAFE 与 IMF BPM6', asOf: '2026-09' }, updatedAt: '2026-09-13', related: ['exports', 'imports', 'trade-balance', 'terms-of-trade', 'current-account'], graph: 'macro', order: 9, level: 'basic', topics: ['balance-of-payments'], prerequisites: ['exports', 'imports'], featured: false },
  'terms-of-trade': { id: 'terms-of-trade', name: '贸易条件', subtitle: '出口价格相对进口价格的比值或指数，不是汇率或贸易差额', country: 'CN', category: 'external', source: '国家外汇管理局、国际货币基金组织与世界贸易组织', definition: { source: 'IMF BPM6 与 WTO trade methodology', asOf: '2026-09' }, updatedAt: '2026-09-13', related: ['trade-volume-and-price', 'exports', 'imports', 'trade-balance', 'exchange-rate'], graph: 'macro', order: 10, level: 'basic', topics: ['balance-of-payments'], prerequisites: ['trade-volume-and-price'], featured: false },
};
