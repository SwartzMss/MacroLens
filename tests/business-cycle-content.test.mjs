...
const approvedMetadata = {
  'output-gap': { id: 'output-gap', name: '产出缺口', subtitle: '实际产出相对潜在产出的估计偏离，不是直接观测的官方 GDP 指标', country: 'CN', category: 'growth', source: '国际货币基金组织与国家统计局', definition: { source: 'IMF output-gap methodology and NBS GDP', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['gdp', 'potential-output', 'capacity-utilization', 'unemployment-rate', 'cpi'], graph: 'macro', order: 6 },
  'inventory-cycle': { id: 'inventory-cycle', name: '库存周期', subtitle: '企业库存存量、变化与需求生产调整形成的条件性周期叙事', country: 'CN', category: 'growth', source: '国家统计局', definition: { source: '国家统计局工业企业财务与国民经济核算口径', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['industrial-production', 'industrial-profits', 'pmi', 'gdp'], graph: 'macro', order: 7 },
  'capacity-utilization': { id: 'capacity-utilization', name: '工业产能利用率', subtitle: '规模以上工业实际产出相对可持续生产能力的季度调查指标', country: 'CN', category: 'growth', source: '国家统计局', definition: { source: '国家统计局工业产能利用率调查', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['industrial-production', 'output-gap', 'industrial-profits', 'ppi'], graph: 'macro', order: 8 },
  'industrial-profits': { id: 'industrial-profits', name: '规模以上工业企业利润', subtitle: '观察规上工业企业累计利润、收入与利润率，必须保持可比口径', country: 'CN', category: 'growth', source: '国家统计局', definition: { source: '国家统计局工业企业财务状况统计', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['industrial-production', 'inventory-cycle', 'capacity-utilization', 'ppi'], graph: 'macro', order: 9 },
  'leading-indicators': { id: 'leading-indicators', name: '领先指标', subtitle: '相对特定经济活动和预测期具有经验领先性的信号角色，不是一条通用序列', country: 'CN', category: 'growth', source: '国家统计局与中国人民银行', definition: { source: '官方指标方法与条件性领先关系', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['pmi', 'credit', 'social-financing', 'yield-curve', 'industrial-production'], graph: 'macro', order: 10 },
};
