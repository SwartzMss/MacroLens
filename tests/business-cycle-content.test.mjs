...
const approvedMetadata = {
  'output-gap': { id: 'output-gap', name: '产出缺口', subtitle: '实际产出相对潜在产出的估计偏离，不是直接观测的官方 GDP 指标', country: 'CN', category: 'growth', source: '国际货币基金组织与国家统计局', definition: { source: 'IMF output-gap methodology and NBS GDP', asOf: '2026-08' }, updatedAt: '2026-08-31', related: ['gdp', 'potential-output', 'capacity-utilization', 'unemployment-rate', 'cpi'], graph: 'macro', order: 6 },
