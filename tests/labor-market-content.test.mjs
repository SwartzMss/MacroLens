...
const approvedMetadata = {
  employment: { id: 'employment', name: '就业', subtitle: '处于就业状态的人口存量，不等于某一期间新增的就业岗位或人员', country: 'CN', category: 'labor', source: '国家统计局', definition: { source: '国家统计局劳动力调查制度', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['unemployment-rate', 'youth-unemployment', 'labor-force-participation', 'wages', 'gdp'], graph: 'macro', order: 1 },
  'unemployment-rate': { id: 'unemployment-rate', name: '城镇调查失业率', subtitle: '城镇失业人口占城镇劳动力的比重，不是占全部劳动年龄人口的比重', country: 'CN', category: 'labor', source: '国家统计局', definition: { source: '国家统计局劳动力调查制度', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['employment', 'youth-unemployment', 'labor-force-participation', 'wages', 'gdp'], graph: 'macro', order: 2 },
  'youth-unemployment': { id: 'youth-unemployment', name: '青年失业率 / 分年龄组失业率', subtitle: '观察不同年龄劳动力的失业状况，必须先确认年龄分组和在校生口径', country: 'CN', category: 'labor', source: '国家统计局', definition: { source: '国家统计局分年龄组调查失业率说明', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['unemployment-rate', 'employment', 'labor-force-participation', 'wages'], graph: 'macro', order: 3 },
  'labor-force-participation': { id: 'labor-force-participation', name: '劳动参与率', subtitle: '劳动力占劳动年龄人口的比重，连接就业、失业与退出劳动力市场', country: 'CN', category: 'labor', source: '国家统计局与国际劳工组织', definition: { source: '国家统计局劳动力调查制度与 ILOSTAT', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['employment', 'unemployment-rate', 'youth-unemployment', 'wages'], graph: 'macro', order: 4 },
  wages: { id: 'wages', name: '工资与劳动报酬', subtitle: '衡量劳动所得时必须区分平均与中位、名义与实际以及统计覆盖范围', country: 'CN', category: 'labor', source: '国家统计局', definition: { source: '国家统计局单位就业人员工资统计制度', asOf: '2026-08' }, updatedAt: '2026-09-13', related: ['employment', 'unemployment-rate', 'labor-force-participation', 'cpi', 'retail-sales'], graph: 'macro', order: 5 },
};
